...
// 물고기의 좌우로 헤엄치는 모션은 이 분의 작업물을 바탕으로 만들었습니다!
...
class Flagellum {
  constructor(_sizeW, _sizeH, _numNodes) {
    ...
    this.spine = new Array(this.numNodes)
      .fill()
  ...
  swim() {
    ...
    this.spine[1][0] =
      -this.spaceX * cos(this.theta + thetaMuscle) + this.spine[0][0];
    this.spine[1][1] =
      -this.spaceX * sin(this.theta + thetaMuscle) + this.spine[0][1];
